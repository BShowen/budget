...
export function TagSelection({ tagList, createNewTag }) {
  return (
    <div className="w-full rounded-lg overflow-hidden px-1 py-1 flex flex-col justify-start items-stretch min-h-10 shadow-sm bg-transaction-form-input-bg-color">
